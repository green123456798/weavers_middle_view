		...
		<div
			...
			<div class="modal-content">
				...
				<div class="modal-body" id="abc">
					<br>
					<button onclick="addAddressInsert()">주소 찾기</button>
					<br>
					<div>
						<br> 배송지명 &nbsp;<input type="text" id="modalInsert_aname"> <br>
						<br> 우편번호 &nbsp;<input type="text" id="modalInsert_zonecode"> <br>
						<br> 지번주소 &nbsp;<input type="text" id="modalInsert_jibunAddress"> <br>
						<br> 도로명주소 &nbsp;<input type="text" id="modalInsert_roadAddress"> <br>
						<br> 상세주소 &nbsp;<input type="text" id="modalInsert_detail"> <br>
						<br>
					</div>
				</div>
				<div class="modal-footer">
		...
		<div
			...
			<div class="modal-content">
				...
				<div class="modal-body" id="zzz">
					<br>
					<button onclick="addAddressUpdate()">주소 찾기</button>
					<br>
					<div>
						<input type="hidden" id="modalUpdate_apk">
						<br>
						배송지명 &nbsp;<input type="text" id="modalUpdate_aname"> <br><br> 
						우편번호 &nbsp;<input type="text" id="modalUpdate_zonecode"> <br><br> 
						지번주소 &nbsp;<input type="text" id="modalUpdate_jibunAddress"> <br><br> 
						도로명주소 &nbsp;<input type="text" id="modalUpdate_roadAddress"> <br><br> 
						상세주소 &nbsp;<input type="text" id="modalUpdate_detail"> <br><br>
					</div>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary"
					...
					<button type="button" class="btn btn-primary"
						onclick="changeSubmit()" data-bs-target="#modalboxSelectAll"
		...
		<div class="container">
			<div class="billing_details">
				<div class="row">
					...
					<form class="row contact_form" action="checkoutSuccess.do"
						method="post" novalidate="novalidate" style="margin: auto;">
						<!-- 주문자 정보 -->
						<div class="col-lg-7">
							<h3>Billing Details</h3>
							<div class="col-md-12 form-group p_star">
								<input type="text" class="form-control" id="checkoutName"
									name="name" placeholder="이름" value="${name}">
							</div>

							<div class="col-md-12 form-group p_star">
								<input type="text" class="form-control" id="checkoutPhone"
									name="phone" placeholder="연락처" value="${phone}">
							</div>

							<div class="col-md-12 form-group p_star">
								<input type="text" class="form-control" id="checkoutEmail"
									name="email" placeholder="이메일" value="${email}">
							</div>
							...
							<div class="col-md-10 form-group">
								<div class="input-group">
									<input type="text" class="form-control" id="checkout_zonecode"
										...
										style="display: inline-block; background-color: #fff" readonly required>
							...
							<div class="col-md-10 form-group">
								<input type="text" class="form-control"
									...
									placeholder="도로명주소" onfocus="this.placeholder = ''"
							...
							<div class="col-md-10 form-group">
								<input type="text" class="form-control" id="checkout_detail"
									name="checkout_detail" placeholder="상세주소" readonly style="display: inline-block; background-color: #fff">
							</div>
								...
								<ul class="list" id="orderList">
									...
									<c:if test="${fn:length(cdatas) > 0}">
										<c:forEach var='data' items='${cdatas}'>
											...
											<span class="last" style="float: right;"><span class="productPrice">${data.price*data.cnt}</span>원</span>
											</li>
										</c:forEach>
									</c:if>
								</ul>
